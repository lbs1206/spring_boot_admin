(function ($) {
    ...
    var pageBtnList = new Vue({
        ...
        methods: {
            ...
            previousClick:function () {
                if(pagination.current_pages !== 0){
                    searchStart(pagination.current_pages-1);
                }
            },
            nextClick:function () {

                if(pagination.current_pages !== pagination.total_pages-1){
                    searchStart(pagination.current_pages+1);
                }
            }
        },
        mounted:function () {
            ...
            setTimeout(function () {
                ...
                $('li[btn_id='+(pagination.current_pages+1)+']').addClass( "active" );
            },50)
        }
    });
    ...
    function searchStart(index) {
        ...
        $.get("/api/user?page="+index, function (response) {
            ...
            showPage.currentPage = pagination.current_pages+1;
            ...
            // 페이징 버튼 처리
            var temp = Math.floor(pagination.current_pages / maxBtnSize);
